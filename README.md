...
This pass (2026-09-11 ~5:54 PM MT): `python scripts/localnet_recreate.py` created Watchdog **appId 1103** at confirmed round **81** (`createTxid` in `docs/localnet.json`). Then `python scripts/localnet_listen.py` created mock keeper **1104**, set_keeper, set_max_age(1000), interested-party `report(42)`, and inner-called `watch` (1 inner). Global after listen: last_value=42, stale=0, watch_count=1, last_watch_round=87. LocalNet last-round after listen: 87. Did not spend the TestNet bank. Did not poke upkeep 81 or 87. Prior LocalNet appIds 1053/1054 (and 1001/1002, 1081/1082, 1014/1015, 1147/1148, 1108/1109) are superseded.
