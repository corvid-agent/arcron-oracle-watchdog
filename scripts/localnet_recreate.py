#!/usr/bin/env python3
"""Recreate Watchdog on AlgoKit LocalNet and write docs/localnet.json.
...
CONTRACT = ROOT / "smart_contracts" / "watchdog" / "contract.py"
ARTIFACT_DIR = ROOT / "smart_contracts" / "artifacts" / "watchdog"
