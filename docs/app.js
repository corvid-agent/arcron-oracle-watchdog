...
async function main() {
  ...
  try {
    ...
    if (stale === 1) {
      ...
      paint("FRESH", "live", "WATCHDOG — FRESH");
    } else {
      paint("WAITING FOR FIRST REPORT", "grounded", "WATCHDOG — waiting for first report");
    }
  } catch (e) {
